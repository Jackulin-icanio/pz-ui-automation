...
import com.propertyzar.ui.annotations.PropertyKey;
import lombok.Data;

@Data
public class Config {

    private static final String ENV_PREFIX = "com.propertyzar.ui.config.";
    ...
    @PropertyKey(ENV_PREFIX + "playwright.chrome.binary")
    private String playwrightChromeBinary;

    @PropertyKey(ENV_PREFIX + "playwright.chrome.channel")
    private String playwrightChromeChannel;

    @PropertyKey(ENV_PREFIX + "playwright.firefox.binary")
    private String playwrightFirefoxBinary;

    @PropertyKey(ENV_PREFIX + "playwright.firefox.channel")
    private String playwrightFirefoxChannel;

    @PropertyKey(ENV_PREFIX + "playwright.webkit.binary")
    private String playwrightWebkitBinary;

    @PropertyKey(ENV_PREFIX + "playwright.webkit.channel")
    private String playwrightWebkitChannel;

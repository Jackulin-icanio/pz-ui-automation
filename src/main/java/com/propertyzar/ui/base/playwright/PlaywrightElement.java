...
public class PlaywrightElement extends Element<PlaywrightWebDriver, Locator> {
    ...
    public void setText(String text) {
        ...
        try {
            ...
            if ("password".equals(elementType)) {
                log.info("Set text for element [{}]", elementName);
                etTest.log(Status.INFO, String.format("Set text for element [%s]", elementName));
            } else {
                log.info("Given text [{}] entered on element [{}], current value [{}]", text, elementName, element.textContent());
                etTest.log(Status.INFO, String.format("Given text [%s] entered on element [%s]", text, elementName));
            }
